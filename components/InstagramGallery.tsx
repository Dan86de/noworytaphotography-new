...
const InstagramGallery = () => {
  ...
  if (isLoading) return <div className="grid grid-cols-1 place-content-center"><p>Loading...</p></div>;
  if (!data) return <div className="grid grid-cols-1 place-content-center"><p>No instagram data</p></div>;
